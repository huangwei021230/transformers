...
from transformers.prune.prune_metadata import OPTPruneMetadata
...
class OPTForCausalLM(OPTPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # Initialize weights and apply final processing
        self.post_init()
        self.prune_metadata.set_instrumented_layers(self.model.decoder.layers)

    def initialize_prune_metadata(self, config):
        self.prune_metadata = OPTPruneMetadata(self, ACT2FN[config.activation_function], config)
